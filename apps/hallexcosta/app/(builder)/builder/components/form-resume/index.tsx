...
const Index = (props: any) => {
  ...
  return (
    ...
    <>
      <SectionPerson name={props.person.name} role={props.person.role} />
      ...
      <SummarySkillsFieldset summary={props.summary} skills={props.skills} />
      ...
      <div className="flex gap-4">
        <SaveButton submitting={isPending} />
        <PreviewResumeButton
          handleOpenModal={() => {
