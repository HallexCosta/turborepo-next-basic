...
const ResumeDatePicker = memo((props: ResumeDatePickerProps) => {
    ...
    const lastDayFromMonth = new Date(limitDate.getFullYear(), limitDate.getMonth() + 1, 0).getDate()
    ...
    return (
        <div>
            ...
            <Datepicker
                ...
                maxDate={new Date(limitDate.getFullYear(), limitDate.getMonth(), lastDayFromMonth)}
                language="pt-BR" labelTodayButton="Hoje"
