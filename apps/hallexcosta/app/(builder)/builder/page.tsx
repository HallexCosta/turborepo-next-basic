...
} from "./mappers/achievement-entity-to-achievement-component-mapper";
...
const page = async () => {
    ...
    const parsedPerson  = _.mapValues(person, replaceNullWithEmptyString) as DeepNonNullable<typeof person>
