...
export async function POST(request: Request, {
    ...
    try {
        ...
        for (const workExperience of data) {
            ...
            workExperience.endDate = workExperience.endDate ? new Date(workExperience.endDate) : null
            ...
            if (alreadyWorkExperience) {
                ...
                const {id: workExperienceReferenceId, ...createWorkExperience} = workExperience
